# Script para crear init-aws.sh con formato Unix correcto
Write-Host "Creando archivo init-aws.sh..." -ForegroundColor Green
...
$filePath = Join-Path $PSScriptRoot "init-aws.sh"

# Escribir el contenido con terminaciones de linea Unix (LF)
$utf8NoBom = New-Object System.Text.UTF8Encoding $false
[System.IO.File]::WriteAllLines($filePath, $scriptContent, $utf8NoBom)

Write-Host "Archivo init-aws.sh creado exitosamente con formato Unix" -ForegroundColor Green
Write-Host "Ubicacion: $filePath" -ForegroundColor Cyan